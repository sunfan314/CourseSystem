...
<body>
	<table id="dg" class="easyui-datagrid"
		...
		rownumbers="true" fitColumns="true" singleSelect="false"></table>
	...
	<div id="toolbar">
		...
		">
				...
				id="actionType" name="actionType" class="easyui-combobox"
	...
	<script type="text/javascript">
		...
		function addStudents() {
			...
			$.messager.confirm('Confirm',
					'Are you sure you want to add these students?',
					function(r) {
						if (r) {
							$.post('addCourseStudents', {
