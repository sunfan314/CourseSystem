...
<body>
	<table id="dg" class="easyui-datagrid"
		style="width: 950px; height: 475px" url="getTeachers"
	...
	<div id="dlg" class="easyui-dialog"
		...
		buttons="#dlg-buttons">
		<div class="ftitle">Teacher Information</div>
		<form id="fm" method="post">
			...
			<div style="padding: 5px">
				<label style="padding-right: 5px">user type:</label> <select
					...
					style="width: 140px;" panelHeight="auto">
					<option value="teacher">Normal Teacher</option>
					<option value="teacherInCharge">Teacher In Charge</option>
				</select>
			</div>
		</form>
	</div>
